...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/acct<blob>=<NULL>/SimpleRegexKitLite.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'SimpleRegexKitLite/Classes/**/*'
  
  # s.resource_bundles = {
  #   'SimpleRegexKitLite' => ['SimpleRegexKitLite/Assets/*.png']
  # }
